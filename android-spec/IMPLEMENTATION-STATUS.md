...
| **4** — Payments & Stripe | … | In progress — slices 1-5 complete + transactions journey slice landed (history/detail flows) and Phase 4 test checklist in `06-payments-stripe.md` fully ticked. **Exit gate remains open** pending full Stripe Connect onboarding/dashboard journey parity and final polish |
...
| [06-payments-stripe.md](06-payments-stripe.md) | [ ] | Phase 4 slices 1-5 complete; PaymentSheet parity/polish + transaction history/detail journey landed; test checklist rows in spec now complete. Remaining for full phase gate: finish Stripe Connect onboarding/dashboard journey parity and final UX polish |
