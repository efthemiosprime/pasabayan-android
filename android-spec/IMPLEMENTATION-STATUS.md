...
| **4** — Payments & Stripe | … | In progress — slices 1-3 complete (contract + repository/domain + ViewModel orchestration/state hardening with expanded unit tests across Payment/Methods/Refund/Tipping/Receipt/StripeConnect/Transaction VMs); UI integration remains |
...
| [06-payments-stripe.md](06-payments-stripe.md) | [ ] | Phase 4 slices 1-3 complete: contract + repository/domain + ViewModel orchestration layers aligned (including fallback/validation guards and VM state-transition tests); UI integration remains for next slice |
