...
| **4** — Payments & Stripe | … | In progress — slices 1-4 complete (contract + repository/domain + ViewModel orchestration + initial UI integration via payments profile hub wired to Payment/Methods/Refund/Tipping/Receipt/StripeConnect/Transaction flows with EN/FR strings and previews); full polish/in-depth journey parity still ongoing |
...
| [06-payments-stripe.md](06-payments-stripe.md) | [ ] | Phase 4 slices 1-4 in progress: contract, repositories, ViewModels, and initial UI integration completed (payments profile hub wired to key payment actions, receipts, methods, and connect status); next step is deep journey parity/polish |
