package com.efthemiosprime.pasabayan.features.onboarding.components
 ...
 * Feature-local component (onboarding only); shared chrome lives under `:core:designsystem`.
 */
@Composable
