...
class RootViewModelTest {
    ...
    private class FakeOnboardingPreferences(
        ...
        var consentSetupCompleted: Boolean = false

        override suspend fun hasCompletedConsentSetup(): Boolean = consentSetupCompleted

        override suspend fun setHasCompletedConsentSetup(completed: Boolean) {
            consentSetupCompleted = completed
        }

        var pushApiOptIn: Boolean = false

        override suspend fun getPushNotificationsApiConsentOptIn(): Boolean = pushApiOptIn

        override suspend fun setPushNotificationsApiConsentOptIn(optedIn: Boolean) {
            pushApiOptIn = optedIn
        }
    }
